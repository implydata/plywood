  ...
  describe("parses", () => {
    it("should parse the mega definition", () => {
      var ex1 = ply()
        ...
        .apply('fallback alt', "$x // backup")
        .apply('all together', "((|$x| // 0)^2).absolute()")
        .apply('identity', "+$x")
      ...
      var ex2 = ply()
        ...
        .apply('fallback alt', $("x").fallback("backup"))
        .apply('all together', $("x").absolute().fallback(0).power(2).absolute())
        .apply('identity', $("x"))
